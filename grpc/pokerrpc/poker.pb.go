...
const file_poker_proto_rawDesc = "" +
	...
	"\x05round\x18\x06 \x01(\x05R\x05round\"\xea\x04\n" +
	"\x06Player\x12\x0e\n" +
	...
	"\x0eGetLastWinners\x12\x1c.poker.GetLastWinnersRequest\x1a\x1d.poker.GetLastWinnersResponse\"\x002\x88\x05\n" +
	"\fLobbyService\x12F\n" +
...
var file_poker_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_poker_proto_goTypes = []any{
	...
	(*ShowdownPlayer)(nil),                 // 38: poker.ShowdownPlayer
	(*Showdown)(nil),                       // 39: poker.Showdown
	(*Player)(nil),                         // 40: poker.Player
	(*Card)(nil),                           // 41: poker.Card
	(*SetPlayerReadyRequest)(nil),          // 42: poker.SetPlayerReadyRequest
	(*SetPlayerReadyResponse)(nil),         // 43: poker.SetPlayerReadyResponse
	(*SetPlayerUnreadyRequest)(nil),        // 44: poker.SetPlayerUnreadyRequest
	(*SetPlayerUnreadyResponse)(nil),       // 45: poker.SetPlayerUnreadyResponse
	(*GetPlayerCurrentTableRequest)(nil),   // 46: poker.GetPlayerCurrentTableRequest
	(*GetPlayerCurrentTableResponse)(nil),  // 47: poker.GetPlayerCurrentTableResponse
	(*ShowCardsRequest)(nil),               // 48: poker.ShowCardsRequest
	(*ShowCardsResponse)(nil),              // 49: poker.ShowCardsResponse
	(*HideCardsRequest)(nil),               // 50: poker.HideCardsRequest
	(*HideCardsResponse)(nil),              // 51: poker.HideCardsResponse
	(*RegisterRequest)(nil),                // 52: poker.RegisterRequest
	(*RegisterResponse)(nil),               // 53: poker.RegisterResponse
	(*LoginRequest)(nil),                   // 54: poker.LoginRequest
	(*RequestLoginCodeRequest)(nil),        // 55: poker.RequestLoginCodeRequest
	(*RequestLoginCodeResponse)(nil),       // 56: poker.RequestLoginCodeResponse
	(*LoginResponse)(nil),                  // 57: poker.LoginResponse
	(*LogoutRequest)(nil),                  // 58: poker.LogoutRequest
	(*LogoutResponse)(nil),                 // 59: poker.LogoutResponse
	(*GetUserInfoRequest)(nil),             // 60: poker.GetUserInfoRequest
	(*GetUserInfoResponse)(nil),            // 61: poker.GetUserInfoResponse
}
var file_poker_proto_depIdxs = []int32{
	0,  // 0: poker.GameUpdate.phase:type_name -> poker.GamePhase
	40, // 1: poker.GameUpdate.players:type_name -> poker.Player
	41, // 2: poker.GameUpdate.community_cards:type_name -> poker.Card
	5,  // 3: poker.GetGameStateResponse.game_state:type_name -> poker.GameUpdate
	41, // 4: poker.EvaluateHandRequest.cards:type_name -> poker.Card
	3,  // 5: poker.EvaluateHandResponse.rank:type_name -> poker.HandRank
	41, // 6: poker.EvaluateHandResponse.best_hand:type_name -> poker.Card
	20, // 7: poker.GetLastWinnersResponse.winners:type_name -> poker.Winner
	3,  // 8: poker.Winner.hand_rank:type_name -> poker.HandRank
	41, // 9: poker.Winner.best_hand:type_name -> poker.Card
	29, // 10: poker.GetTablesResponse.tables:type_name -> poker.Table
	40, // 11: poker.Table.players:type_name -> poker.Player
	0,  // 12: poker.Table.phase:type_name -> poker.GamePhase
	2,  // 13: poker.Notification.type:type_name -> poker.NotificationType
	41, // 14: poker.Notification.cards:type_name -> poker.Card
	...
	39, // 18: poker.Notification.showdown:type_name -> poker.Showdown
	41, // 19: poker.ShowdownPlayer.hole_cards:type_name -> poker.Card
	...
	41, // 22: poker.ShowdownPlayer.best_hand:type_name -> poker.Card
	20, // 23: poker.Showdown.winners:type_name -> poker.Winner
	41, // 24: poker.Showdown.board:type_name -> poker.Card
	38, // 25: poker.Showdown.players:type_name -> poker.ShowdownPlayer
	41, // 26: poker.Player.hand:type_name -> poker.Card
	...
	48, // 29: poker.PokerService.ShowCards:input_type -> poker.ShowCardsRequest
	50, // 30: poker.PokerService.HideCards:input_type -> poker.HideCardsRequest
	...
	25, // 40: poker.LobbyService.LeaveTable:input_type -> poker.LeaveTableRequest
	27, // 41: poker.LobbyService.GetTables:input_type -> poker.GetTablesRequest
	46, // 42: poker.LobbyService.GetPlayerCurrentTable:input_type -> poker.GetPlayerCurrentTableRequest
	42, // 43: poker.LobbyService.SetPlayerReady:input_type -> poker.SetPlayerReadyRequest
	44, // 44: poker.LobbyService.SetPlayerUnready:input_type -> poker.SetPlayerUnreadyRequest
	36, // 45: poker.LobbyService.StartNotificationStream:input_type -> poker.StartNotificationStreamRequest
	55, // 46: poker.AuthService.RequestLoginCode:input_type -> poker.RequestLoginCodeRequest
	52, // 47: poker.AuthService.Register:input_type -> poker.RegisterRequest
	54, // 48: poker.AuthService.Login:input_type -> poker.LoginRequest
	58, // 49: poker.AuthService.Logout:input_type -> poker.LogoutRequest
	60, // 50: poker.AuthService.GetUserInfo:input_type -> poker.GetUserInfoRequest
	5,  // 51: poker.PokerService.StartGameStream:output_type -> poker.GameUpdate
	49, // 52: poker.PokerService.ShowCards:output_type -> poker.ShowCardsResponse
	51, // 53: poker.PokerService.HideCards:output_type -> poker.HideCardsResponse
	7,  // 54: poker.PokerService.MakeBet:output_type -> poker.MakeBetResponse
	13, // 55: poker.PokerService.CallBet:output_type -> poker.CallBetResponse
	9,  // 56: poker.PokerService.FoldBet:output_type -> poker.FoldBetResponse
	11, // 57: poker.PokerService.CheckBet:output_type -> poker.CheckBetResponse
	15, // 58: poker.PokerService.GetGameState:output_type -> poker.GetGameStateResponse
	17, // 59: poker.PokerService.EvaluateHand:output_type -> poker.EvaluateHandResponse
	19, // 60: poker.PokerService.GetLastWinners:output_type -> poker.GetLastWinnersResponse
	22, // 61: poker.LobbyService.CreateTable:output_type -> poker.CreateTableResponse
	24, // 62: poker.LobbyService.JoinTable:output_type -> poker.JoinTableResponse
	26, // 63: poker.LobbyService.LeaveTable:output_type -> poker.LeaveTableResponse
	28, // 64: poker.LobbyService.GetTables:output_type -> poker.GetTablesResponse
	47, // 65: poker.LobbyService.GetPlayerCurrentTable:output_type -> poker.GetPlayerCurrentTableResponse
	43, // 66: poker.LobbyService.SetPlayerReady:output_type -> poker.SetPlayerReadyResponse
	45, // 67: poker.LobbyService.SetPlayerUnready:output_type -> poker.SetPlayerUnreadyResponse
	37, // 68: poker.LobbyService.StartNotificationStream:output_type -> poker.Notification
	56, // 69: poker.AuthService.RequestLoginCode:output_type -> poker.RequestLoginCodeResponse
	53, // 70: poker.AuthService.Register:output_type -> poker.RegisterResponse
	57, // 71: poker.AuthService.Login:output_type -> poker.LoginResponse
	59, // 72: poker.AuthService.Logout:output_type -> poker.LogoutResponse
	61, // 73: poker.AuthService.GetUserInfo:output_type -> poker.GetUserInfoResponse
