...
class PokerServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.GameUpdate> startGameStream(
  ...
  $grpc.ResponseFuture<$0.ShowCardsResponse> showCards(
    $0.ShowCardsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$showCards, request, options: options);
  }

  $grpc.ResponseFuture<$0.HideCardsResponse> hideCards(
    $0.HideCardsRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Player actions
  $grpc.ResponseFuture<$0.MakeBetResponse> makeBet(
    $0.MakeBetRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$makeBet, request, options: options);
  }

  $grpc.ResponseFuture<$0.CallBetResponse> callBet(
    $0.CallBetRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$callBet, request, options: options);
  }

  $grpc.ResponseFuture<$0.FoldBetResponse> foldBet(
    $0.FoldBetRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$foldBet, request, options: options);
  }

  $grpc.ResponseFuture<$0.CheckBetResponse> checkBet(
    $0.CheckBetRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Game state
  $grpc.ResponseFuture<$0.GetGameStateResponse> getGameState(
    $0.GetGameStateRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetLastWinnersResponse> getLastWinners(
    $0.GetLastWinnersRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$startGameStream =
      $grpc.ClientMethod<$0.StartGameStreamRequest, $0.GameUpdate>(
          '/poker.PokerService/StartGameStream',
          ($0.StartGameStreamRequest value) => value.writeToBuffer(),
          $0.GameUpdate.fromBuffer);
  static final _$showCards =
      $grpc.ClientMethod<$0.ShowCardsRequest, $0.ShowCardsResponse>(
          '/poker.PokerService/ShowCards',
          ($0.ShowCardsRequest value) => value.writeToBuffer(),
          $0.ShowCardsResponse.fromBuffer);
  static final _$hideCards =
      $grpc.ClientMethod<$0.HideCardsRequest, $0.HideCardsResponse>(
          '/poker.PokerService/HideCards',
          ($0.HideCardsRequest value) => value.writeToBuffer(),
          $0.HideCardsResponse.fromBuffer);
  static final _$makeBet =
      $grpc.ClientMethod<$0.MakeBetRequest, $0.MakeBetResponse>(
          '/poker.PokerService/MakeBet',
          ($0.MakeBetRequest value) => value.writeToBuffer(),
          $0.MakeBetResponse.fromBuffer);
  static final _$callBet =
      $grpc.ClientMethod<$0.CallBetRequest, $0.CallBetResponse>(
          '/poker.PokerService/CallBet',
          ($0.CallBetRequest value) => value.writeToBuffer(),
          $0.CallBetResponse.fromBuffer);
  static final _$foldBet =
      $grpc.ClientMethod<$0.FoldBetRequest, $0.FoldBetResponse>(
          '/poker.PokerService/FoldBet',
          ($0.FoldBetRequest value) => value.writeToBuffer(),
          $0.FoldBetResponse.fromBuffer);
  static final _$checkBet =
      $grpc.ClientMethod<$0.CheckBetRequest, $0.CheckBetResponse>(
          '/poker.PokerService/CheckBet',
          ($0.CheckBetRequest value) => value.writeToBuffer(),
          $0.CheckBetResponse.fromBuffer);
  static final _$getGameState =
      $grpc.ClientMethod<$0.GetGameStateRequest, $0.GetGameStateResponse>(
          '/poker.PokerService/GetGameState',
          ($0.GetGameStateRequest value) => value.writeToBuffer(),
          $0.GetGameStateResponse.fromBuffer);
  ...
  static final _$getLastWinners =
      $grpc.ClientMethod<$0.GetLastWinnersRequest, $0.GetLastWinnersResponse>(
          '/poker.PokerService/GetLastWinners',
          ($0.GetLastWinnersRequest value) => value.writeToBuffer(),
          $0.GetLastWinnersResponse.fromBuffer);
}
...
abstract class PokerServiceBase extends $grpc.Service {
  ...
  PokerServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.GetGameStateRequest, $0.GetGameStateResponse>(
            'GetGameState',
            getGameState_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetGameStateRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetLastWinnersRequest,
            $0.GetLastWinnersResponse>(
        'GetLastWinners',
        getLastWinners_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetLastWinnersRequest.fromBuffer(value),
        ($0.GetLastWinnersResponse value) => value.writeToBuffer()));
  }

  $async.Stream<$0.GameUpdate> startGameStream_Pre($grpc.ServiceCall $call,
      $async.Future<$0.StartGameStreamRequest> $request) async* {
    yield* startGameStream($call, await $request);
  }

  $async.Stream<$0.GameUpdate> startGameStream(
      $grpc.ServiceCall call, $0.StartGameStreamRequest request);

  $async.Future<$0.ShowCardsResponse> showCards_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ShowCardsRequest> $request) async {
    return showCards($call, await $request);
  }

  $async.Future<$0.ShowCardsResponse> showCards(
      $grpc.ServiceCall call, $0.ShowCardsRequest request);

  $async.Future<$0.HideCardsResponse> hideCards_Pre($grpc.ServiceCall $call,
      $async.Future<$0.HideCardsRequest> $request) async {
    return hideCards($call, await $request);
  }

  $async.Future<$0.HideCardsResponse> hideCards(
      $grpc.ServiceCall call, $0.HideCardsRequest request);

  $async.Future<$0.MakeBetResponse> makeBet_Pre($grpc.ServiceCall $call,
      $async.Future<$0.MakeBetRequest> $request) async {
    return makeBet($call, await $request);
  }

  $async.Future<$0.MakeBetResponse> makeBet(
      $grpc.ServiceCall call, $0.MakeBetRequest request);

  $async.Future<$0.CallBetResponse> callBet_Pre($grpc.ServiceCall $call,
      $async.Future<$0.CallBetRequest> $request) async {
    return callBet($call, await $request);
  }

  $async.Future<$0.CallBetResponse> callBet(
      $grpc.ServiceCall call, $0.CallBetRequest request);

  $async.Future<$0.FoldBetResponse> foldBet_Pre($grpc.ServiceCall $call,
      $async.Future<$0.FoldBetRequest> $request) async {
    return foldBet($call, await $request);
  }

  $async.Future<$0.FoldBetResponse> foldBet(
      $grpc.ServiceCall call, $0.FoldBetRequest request);

  $async.Future<$0.CheckBetResponse> checkBet_Pre($grpc.ServiceCall $call,
      $async.Future<$0.CheckBetRequest> $request) async {
    return checkBet($call, await $request);
  }

  $async.Future<$0.CheckBetResponse> checkBet(
      $grpc.ServiceCall call, $0.CheckBetRequest request);

  $async.Future<$0.GetGameStateResponse> getGameState_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetGameStateRequest> $request) async {
    return getGameState($call, await $request);
  }

  $async.Future<$0.GetGameStateResponse> getGameState(
      $grpc.ServiceCall call, $0.GetGameStateRequest request);
  ...
  $async.Future<$0.GetLastWinnersResponse> getLastWinners_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetLastWinnersRequest> $request) async {
    return getLastWinners($call, await $request);
  }

  $async.Future<$0.GetLastWinnersResponse> getLastWinners(
      $grpc.ServiceCall call, $0.GetLastWinnersRequest request);
}
...
class LobbyServiceClient extends $grpc.Client {
  ...
  LobbyServiceClient(super.channel, {super.options, super.interceptors});
  ...
  $grpc.ResponseFuture<$0.JoinTableResponse> joinTable(
    $0.JoinTableRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetTablesResponse> getTables(
    $0.GetTablesRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getTables, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetPlayerCurrentTableResponse> getPlayerCurrentTable(
    $0.GetPlayerCurrentTableRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.SetPlayerUnreadyResponse> setPlayerUnready(
    $0.SetPlayerUnreadyRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Notification stream
  $grpc.ResponseStream<$0.Notification> startNotificationStream(
    $0.StartNotificationStreamRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$startNotificationStream, $async.Stream.fromIterable([request]),
        options: options);
  }
  ...
  static final _$joinTable =
      $grpc.ClientMethod<$0.JoinTableRequest, $0.JoinTableResponse>(
  ...
  static final _$getTables =
      $grpc.ClientMethod<$0.GetTablesRequest, $0.GetTablesResponse>(
          ...
          $0.GetTablesResponse.fromBuffer);
  static final _$getPlayerCurrentTable = $grpc.ClientMethod<
          $0.GetPlayerCurrentTableRequest, $0.GetPlayerCurrentTableResponse>(
  ...
  static final _$setPlayerReady =
      $grpc.ClientMethod<$0.SetPlayerReadyRequest, $0.SetPlayerReadyResponse>(
          ...
          $0.SetPlayerReadyResponse.fromBuffer);
  static final _$setPlayerUnready = $grpc.ClientMethod<
          $0.SetPlayerUnreadyRequest, $0.SetPlayerUnreadyResponse>(
      '/poker.LobbyService/SetPlayerUnready',
      ($0.SetPlayerUnreadyRequest value) => value.writeToBuffer(),
      $0.SetPlayerUnreadyResponse.fromBuffer);
  static final _$startNotificationStream =
      $grpc.ClientMethod<$0.StartNotificationStreamRequest, $0.Notification>(
...
abstract class LobbyServiceBase extends $grpc.Service {
  ...
  LobbyServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetPlayerCurrentTableRequest,
            $0.GetPlayerCurrentTableResponse>(
    ...
    $addMethod($grpc.ServiceMethod<$0.SetPlayerReadyRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.SetPlayerReadyRequest.fromBuffer(value),
        ($0.SetPlayerReadyResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SetPlayerUnreadyRequest,
            $0.SetPlayerUnreadyResponse>(
        'SetPlayerUnready',
        setPlayerUnready_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.SetPlayerUnreadyRequest.fromBuffer(value),
        ($0.SetPlayerUnreadyResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.StartNotificationStreamRequest, $0.Notification>(
            'StartNotificationStream',
            startNotificationStream_Pre,
            false,
            true,
            ($core.List<$core.int> value) =>
                $0.StartNotificationStreamRequest.fromBuffer(value),
  ...
  $async.Future<$0.JoinTableResponse> joinTable_Pre($grpc.ServiceCall $call,
      $async.Future<$0.JoinTableRequest> $request) async {
  ...
  $async.Future<$0.GetTablesResponse> getTables(
      $grpc.ServiceCall call, $0.GetTablesRequest request);

  $async.Future<$0.GetPlayerCurrentTableResponse> getPlayerCurrentTable_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetPlayerCurrentTableRequest> $request) async {
  ...
  $async.Future<$0.SetPlayerReadyResponse> setPlayerReady_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.SetPlayerReadyRequest> $request) async {
    return setPlayerReady($call, await $request);
  }

  $async.Future<$0.SetPlayerReadyResponse> setPlayerReady(
      $grpc.ServiceCall call, $0.SetPlayerReadyRequest request);

  $async.Future<$0.SetPlayerUnreadyResponse> setPlayerUnready_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.SetPlayerUnreadyRequest> $request) async {
    return setPlayerUnready($call, await $request);
  }

  $async.Future<$0.SetPlayerUnreadyResponse> setPlayerUnready(
      $grpc.ServiceCall call, $0.SetPlayerUnreadyRequest request);

  $async.Stream<$0.Notification> startNotificationStream_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.StartNotificationStreamRequest> $request) async* {
