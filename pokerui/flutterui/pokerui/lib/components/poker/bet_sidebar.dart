...
class BetSidebar extends StatelessWidget {
  const BetSidebar({
    super.key,
  ...
  int _getToCall() {
    ...
    final toCall = gameState.currentBet - playerBet;
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      top: 150, // Positioned below minimal showdown with more spacing
      right: 12,
      child: SafeArea(
        child: Material(
          color: Colors.transparent,
          child: Container(
            constraints: BoxConstraints(maxWidth: 280 * theme.uiSizeMultiplier),
